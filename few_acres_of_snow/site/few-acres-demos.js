...
function PJRCreateCardInfo(n, t, i, r) {
    ...
    var u = "",
        ...
        o, l, f;
    const format1 = "<div style='position:absolute;top:70px;left:10px;width:240px;height:320px;border:1px solid black;overflow:auto;background-color:silver'>";
    ...
    if (
        ...
        u += "<div style='background-color:" + a + "'><b>" + c + " " + StrIsEmpty + "<\/b><\/div></br>";

    } else if (
        !IsHistory && (n === 1 && t || n === 5)
    )
        // u += "<tr style='background-color:" + a + "'><td><b>" + StrHiddenInfo + "<\/b><br/>" + StrHiddenInfo2 + "<\/td><\/tr>";
        u += "<tr style='background-color:" + a + "'><td><b> n === 1 && t || n === 5</b><br/>StrHiddenInfo" + StrHiddenInfo
            + "<\/b><br/>StrHiddenInfo2" + StrHiddenInfo2 + "<\/td><\/tr>";
...
function doLine309(o, e, f, l, p, s) {
    o = e.substr(f, 1), IsNeutralCard(o) ? (l = o, p = "Neutral") : (l = Decode(e, f), p = s === 0 ? "British" : "French"), $("#ciCard" + f).mouseover(function (n, t) {
        return function () {
            ShowCardInfoCard(n, t)
        }
    }(l, p))
...
function PJRCreateCardInfo(pile, isOpponent, i, r) {
    ...
    function conditionForEmpty() {
        return "<h2 align='center'>" + c + "<\/h2>", u += "<div style='position:absolute;top:70px;left:10px;width:240px;height:320px;border:1px solid black;overflow:auto;background-color:silver'>", u += "<table border='1' cellpadding='4' style='width:100%'>", e.length === 0;
    }
    ...
    // else if (!IsHistory && (n === 1 && t || n === 5)) u +="<tr style='background-color:" + a + "'><td><b>" + StrHiddenInfo + "<\/b><br/>" + StrHiddenInfo2 + "<\/td><\/tr>";
        ...
        console.log(`Apparently in the history OK or this is my hand OK case. n=${pile}`)
        console.log(`Hidden info: ${StrHiddenInfo} -- ${StrHiddenInfo2}`)
        for (w = 1, u += "<tr style='background-color:#D9C58A'>", u += "<td colspan='3' style='text-align:center'><b>" + StrTop + "<\/b>", u += "<\/td>", u += "<\/tr>", f = e.length - 1; f >= 0; f--)
            o = e.substr(f, 1),
                a = IsNeutralCard(o) ? "#9DCC4D" :
                    s === 0 ? "#EF9D77" : "#9DD7F2",
                // u +="<tr style='background-color:" + a + "'>",
                // u +="<td style='background-color:silver;text-align:right'><b>" + w + ".<\/b><\/td>",
                u += "<td id='ciCard" + f + "'>", IsLocationCard(s, o) ? (l = Decode(e, f), u += locationData[b[l][0][2]][0]) : u += IsNeutralCard(o) ? empTitles[empDataN[GetNeutralIndex(o)][2]] : empTitles[y[GetEmpireIndex(s, o)][2]],
                ...
                u = `<div><br/><br/><br/><font size="30pt">${Decode(e, f)}</font><br/><br/><br/></div><div>${u}</div>`
    } else
        for (pile === 1 && (e = GetSortedDeck(h), u += "<tr style='background-color:#D9C58A'>", u += "<td colspan='3' style='text-align:center'>" + StrSorted, u += "<\/td>", u += "<\/tr>"), f = 0; f < e.length; f++)
            o = e.substr(f, 1), a = IsNeutralCard(o) ? "#9DCC4D" : s === 0 ? "#EF9D77" : "#9DD7F2", u += "<tr style='background-color:" + a + "'>", u += "<td style='background-color:silver;text-align:right'><b>" + (f + 1) + ".<\/b><\/td>", u += "<td id='ciCard" + f + "'>", IsLocationCard(s, o) ? (l = Decode(e, f), u += locationData[b[l][0][2]][0]) : u += IsNeutralCard(o) ? empTitles[empDataN[GetNeutralIndex(o)][2]] : empTitles[y[GetEmpireIndex(s, o)][2]], u += "<\/td>", pile === 4 && (u += "<td title='costs for drafting this card' style='cursor:default'>" + y[GetEmpireIndex(s, o)][3], u += "<\/td>"), u += "<\/tr>";
    for (
        u += "<\/table>",
...
const SELF = false, OPPONENT = true
const RESERVE = 0, DECK = 1, DISCARD = 2, LOCATION = 3, EMPIRE = 4
